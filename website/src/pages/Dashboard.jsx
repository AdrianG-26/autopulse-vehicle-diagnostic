...
export default function Dashboard({ onNavigate }) {
  ...
  // Health Score is converted from engine_stress_score (0-15) to 0-100 scale
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      {fmt(sensorData?.timingAdvance, 1)}
                      <span
                        style={{
                          fontSize: "0.875rem",
                          color: "#6b7280",
                  ...
                  >
                    ...
                    >
                      {fmt(sensorData?.barometricPressure, 1)}
                      <span
                        style={{
                          fontSize: "0.875rem",
                          color: "#6b7280",
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        fontWeight: "700",
                        color:
                          sensorData?.controlModuleVoltage >= 12
                            ? "#10b981"
                            : "#ef4444",
                      }}
                    >
                      {fmt(sensorData?.controlModuleVoltage, 2)}
                      <span
                        style={{
                          fontSize: "0.875rem",
                          color: "#6b7280",
                  ...
                  >
                    ...
                    >
                      {fmt(sensorData?.engineRuntime, 0)}
                      <span
                        style={{
                          fontSize: "0.875rem",
                          color: "#6b7280",
