...
export default function LoginForm({ onLogin, onSignup, onContactAdmin }) {
  ...
  const validateUsername = async (username) => {
    ...
    if (!username) return isSignup ? 'Username is required' : 'Username or email is required';
    
    // For LOGIN: Allow email format (skip username-specific validation)
    if (!isSignup && username.includes('@')) {
      // It's an email, just do basic email validation
      if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(username)) {
        return 'Please enter a valid email address';
      }
      return ''; // Valid email for login
    }
    
    // For SIGNUP or username login: Apply username rules
        ...
        <div className="form-group">
          ...
          <div className="input-wrapper" style={{ position: 'relative' }}>
            ...
            <input
              ...
              disabled={isLoading}
              style={{ paddingRight: validFields.password ? '75px' : '45px' }}
            />
            <button
              type="button"
              ...
              style={{
                position: 'absolute',
                right: validFields.password ? '40px' : '12px',
                top: '50%',
                transform: 'translateY(-50%)',
                background: 'none',
                border: 'none',
          ...
          <div className="form-group">
            ...
            <div className="input-wrapper" style={{ position: 'relative' }}>
              ...
              <input
                ...
                disabled={isLoading}
                style={{ paddingRight: validFields.confirmPassword ? '75px' : '45px' }}
              />
              <button
                type="button"
                ...
                style={{
                  position: 'absolute',
                  right: validFields.confirmPassword ? '40px' : '12px',
                  top: '50%',
                  transform: 'translateY(-50%)',
                  background: 'none',
                  border: 'none',
